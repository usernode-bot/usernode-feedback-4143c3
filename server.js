...
async function seedStaging() {
  // Seed daily activity leaderboard: reserved fake id range, "Staging demo"
  // usernames, a spread of press counts including a login-only case (Eve).
  const demo = [
  ...
  // Seed marketplace listings: fake sellers use negative sentinel ids so they
  // never collide with real users. Idempotent — skips if listings already exist.
  const fakes = [
